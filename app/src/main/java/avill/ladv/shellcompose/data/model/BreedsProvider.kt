...
class BreedsProvider {
    //is like a static object
    companion object {
        //var images:List<String> = emptyList()
        /*lateinit var breedsPuppy:List<String>
        var breedList:ArrayList<Breed> = arrayListOf()
        fun getBreedsRandom():List<String>{
            breedsPuppy=breeds.shuffled().subList(0,12)
            return breedsPuppy
        }
